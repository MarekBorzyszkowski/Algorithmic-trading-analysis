...
class QSvcAlgorithm(TradingAlgorithm):
    ...
    def save(self, directory: str):
        with open(os.path.join(directory, "qsvc_scaler_x.pkl"), "wb") as f:
            pickle.dump(self.scaler_X, f)

        with open(os.path.join(directory, "qsvc_scaler_y.pkl"), "wb") as f:
            pickle.dump(self.scaler_Y, f)

        with open(os.path.join(directory, "qsvc_model.pkl"), "wb") as f:
            pickle.dump(self.model, f)

    def load(self, directory: str):
        with open(os.path.join(directory, "qsvc_scaler_x.pkl"), "rb") as f:
            self.scaler_X = pickle.load(f)

        with open(os.path.join(directory, "qsvc_scaler_y.pkl"), "rb") as f:
            self.scaler_Y = pickle.load(f)

        with open(os.path.join(directory, "qsvc_model.pkl"), "rb") as f:
