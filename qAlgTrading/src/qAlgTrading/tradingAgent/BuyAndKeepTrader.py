...
from qAlgTrading.algorithms.SIGNALS_CONSTS import BUY
...
class BuyAndKeepTrader(Trader):
    ...
    def name(self):
        return f"Kup i trzymaj: {self.max_percentage_of_value_in_one_trade * 100}%"

    def nameSimple(self):
        return f"kit {self.max_percentage_of_value_in_one_trade * 100}%"
